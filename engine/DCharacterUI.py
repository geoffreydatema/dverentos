...
class DCharacterUI(DScreen):
    def __init__(self, parent: QWidget, game_manager: GameManager, image_path: str="assets/character_ui/character_ui_grid_v001.png") -> None:
    ...
    def build_ui(self):
        ...
        # name plate ==============================================================
        self.name_container = DGridContainer(self, 0, 0)
        ...
        # attributes ==============================================================
        self.attributes_container = DGridContainer(self, 2, 0)
        ...
        # inventory preview =======================================================
        self.inventory_preview_container = DGridContainer(self, 4, 0)
        ...
        # statuses preview ========================================================
        self.statuses_preview_container = DGridContainer(self, 4, 4)
        ...
        # character values ========================================================
        self.character_values_container = DGridContainer(self, 5, 0)
